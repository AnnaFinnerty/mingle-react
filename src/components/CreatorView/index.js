...
import { Modal, Feed, Grid, Button, Label, TextArea } from 'semantic-ui-react';
            ...
            <React.Fragment>
                <Grid columns={2} divided fluid="true">
                    ...
                    <Grid.Column>
                        ...
                        <Grid.Row>
                            <ActivePlaylist authUser={this.props.userId} playlistId={this.state.playlistId} history={this.props.history} match={this.props.match} location={this.props.location} />
                        </Grid.Row>
                    </Grid.Column>
                </Grid>
                <Modal open={this.state.modalOpen}>
                    <Button onClick={this.closeModal}>X</Button>
                    <ModalWindow closeModal={this.closeModal} modalType={this.state.modalType}/>
                </Modal>
            </React.Fragment>
